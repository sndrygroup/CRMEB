...
export default {
  router: {
    ...
    menu2: '菜单2',
    funIndex: '功能',
    funTagsView: 'tagsView الخيارات',
    funSignCanvas: '在线签名',
    funCountup: 'countup 数字滚动',
    funEchartsTree: 'echartsTree 树图',
    funSelector: '图标选择器',
    funWangEditor: 'wangEditor تحرير器',
    ...
    pagesFilteringDetails: '过滤筛选组件تفاصيل',
    pagesFilteringDetails1: '过滤筛选组件تفاصيل111',
  ...
  user: {
    ...
    dropdown3: '404',
    dropdown4: '401',
    dropdown5: '退出تسجيل الدخول',
    dropdown6: '个人中心',
    searchPlaceholder: '菜单بحث：菜单الاسم、配置الاسم',
    newTitle: '通知',
    newBtn: '全部已读',
    newGo: '前往通知中心',
    newDesc: '暂无通知',
    logOutTitle: 'تنبيه',
    logOutMessage: '此الخيارات将退出تسجيل الدخول, 是否继续?',
    logOutConfirm: '确定',
    logOutCancel: 'إلغاء',
    logOutExit: '退出中',
  ...
  layout: {
    ...
    sixTransverse: '横向',
    sixColumns: '分栏',
    tipText: '点击下方按钮，复制布局配置去 `src/store/modules/themeConfig.js` 中تعديل。',
    copyText: '一键复制配置',
    resetText: '一键恢复默认',

    ...
    <div class="acea-row row-between-wrapper mb20">
      <div class="statics-header-title">
        ...
        <el-tooltip width="500" placement="right-start">
          ...
          <div slot="content">
            <div>商品浏览量</div>
            <div>在选定条件下，所有商品تفاصيل页被访问的次数，一个人在统计الوقت内访问多次记为多次</div>
            <br />
            <div>商品访客数</div>
            <div>在选定条件下，访问任何商品تفاصيل页的人数，一个人在统计الوقت范围内访问多次只记为一个</div>
            <br />
            <div>支付件数</div>
            <div>
              在选定条件下，成功付款订单的商品件数之和（拼团商品在成团之后计入，线下支付订单在后台تأكيد支付后计入，不剔除退款订单）
            </div>
            <br />
            <div>支付金额</div>
            <div>
              在选定条件下，成功付款订单的商品金额之和（拼团商品在成团之后计入，线下支付订单在后台تأكيد支付后计入，不剔除退款订单）
            </div>
            <br />
            <div>退款件数</div>
